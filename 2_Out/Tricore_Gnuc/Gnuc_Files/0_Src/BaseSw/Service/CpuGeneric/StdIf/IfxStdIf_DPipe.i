...
void IfxStdIf_DPipe_print(IfxStdIf_DPipe *stdif, pchar format, ...)
{
    if (!stdif->txDisabled)
    {
        ...
        (((count < (255)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"count < STDIF_DPIPE_MAX_PRINT_SIZE", "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_DPipe.c", 44, __func__));
