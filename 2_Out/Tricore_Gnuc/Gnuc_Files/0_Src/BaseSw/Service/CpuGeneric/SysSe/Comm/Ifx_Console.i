...
boolean Ifx_Console_print(pchar format, ...)
{
    if (!Ifx_g_console.standardIo->txDisabled)
    {
        ...
        (((count < (255)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"count < STDIF_DPIPE_MAX_PRINT_SIZE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c", 63, __func__));
...
boolean Ifx_Console_printAlign(pchar format, ...)
{
    if (!Ifx_g_console.standardIo->txDisabled)
    {
        ...
        __builtin_va_end(args);
        count = (Ifx_SizeT)strlen(message);
        (((count < (255)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"count < STDIF_DPIPE_MAX_PRINT_SIZE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c", 93, __func__));
