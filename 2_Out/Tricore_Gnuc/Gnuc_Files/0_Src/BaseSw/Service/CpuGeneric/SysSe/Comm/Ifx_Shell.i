...
static boolean Ifx_Shell_writeResult(Ifx_Shell *shell, Ifx_SizeT Code)
{
    ...
    (((result != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"result != FALSE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 80, __func__));
...
# 409 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c"
        ...
        for (i = 0; i < count; i++)
        {
            ...
            (((Cmd->length >= Cmd->cursor) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->length >= Cmd->cursor", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 591, __func__));
...
void Ifx_Shell_cmdEscapeProcess(Ifx_Shell *shell, char EscapeChar1, char EscapeChar2)
{
    ...
    (((result != 0) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"result != FALSE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 1082, __func__));
    ...
    (((cmdStr != ((void *)0)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"cmdStr != NULL_PTR", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 1094, __func__));
    (((Cmd->cursor < (128)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->cursor < IFX_CFG_SHELL_CMD_LINE_SIZE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 1095, __func__));
    (((Cmd->length < (128)) || ((2) > Assert_verboseLevel)) ? ((void)0) : Ifx_Assert_doLevel((2),"Cmd->length < IFX_CFG_SHELL_CMD_LINE_SIZE", "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Shell.c", 1096, __func__));
