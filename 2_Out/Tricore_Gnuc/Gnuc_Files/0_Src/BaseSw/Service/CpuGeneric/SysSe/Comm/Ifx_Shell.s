...
.LBB50:
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.3415
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 80
	lea	%a6, [%a6] lo:__func__.3415
	st.w	[%SP]0, %d2
...
.L451:
	...
	movh.a	%a4, hi:.LC35
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.3527
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC35
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 591
	lea	%a6, [%a6] lo:__func__.3527
	call	Ifx_Assert_doLevel
.LVL365:
.L452:
	add.a	%a12, 1
...
.section .rodata.__func__.3666,"a",@progbits
	.type	__func__.3666, @object
	.size	__func__.3666, 27
__func__.3666:
	.string	"Ifx_Shell_cmdEscapeProcess"
.section .rodata.__func__.3415,"a",@progbits
	.type	__func__.3415, @object
	.size	__func__.3415, 22
__func__.3415:
	.string	"Ifx_Shell_writeResult"
.section .rodata.__func__.3527,"a",@progbits
	.type	__func__.3527, @object
	.size	__func__.3527, 18
__func__.3527:
...
.Letext0:
	...
	.file 10 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-1.1\\tricore\\include\\string.h"
