...
.LVL181:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.6597
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 695
	lea	%a6, [%a6] lo:__func__.6597
...
.LVL260:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.6643
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 861
	lea	%a6, [%a6] lo:__func__.6643
	call	Ifx_Assert_doLevel
.LVL261:
.L190:
...
.LVL339:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.6689
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 1025
	lea	%a6, [%a6] lo:__func__.6689
	call	Ifx_Assert_doLevel
.LVL340:
.L244:
