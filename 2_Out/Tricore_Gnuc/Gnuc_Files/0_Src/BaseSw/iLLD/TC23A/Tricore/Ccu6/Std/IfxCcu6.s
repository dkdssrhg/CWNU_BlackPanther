...
.LVL141:
	movh.a	%a5, hi:.LC1
.LVL142:
	movh.a	%a6, hi:__func__.10096
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 418
	lea	%a6, [%a6] lo:__func__.10096
...
.LVL175:
	movh.a	%a5, hi:.LC1
.LVL176:
	movh.a	%a6, hi:__func__.10124
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 506
	lea	%a6, [%a6] lo:__func__.10124
	j	Ifx_Assert_doLevel
.LVL177:
.L132:
	ret
...
.Letext0:
	...
	.file 14 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Assert.h"
	.file 15 "0_Src/BaseSw/iLLD/TC23A/Tricore/Scu/Std/IfxScuWdt.h"
	.file 16 "0_Src/BaseSw/iLLD/TC23A/Tricore/Scu/Std/IfxScuCcu.h"
