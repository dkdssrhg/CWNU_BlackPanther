# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
# 1 "C:\\Users\\hyunii\\Documents\\InfineonRacer\\src\\InfineonRacer_TC23A//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
# 30 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
...
# 31 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c" 2
...
{
# 142 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
    uint32 x = *seed;
    ...
    uint32 m = 0xfffffffb;
    uint32 result;
# 163 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
...
# 190 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
    * seed = result;
...
{
# 336 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu.c"
    uint8 reqslp;
    boolean retValue;
    IfxCpu_ResourceCpu index = IfxCpu_getIndex(cpu);
...
void IfxCpu_waitEvent(IfxCpu_syncEvent *event, uint32 timeoutMilliSec)
{
    ...
    while ((*sync != (0x1)) &&
           ((uint32)((*(volatile Ifx_STM_TIM0 *)0xF0000010u).U - stmCountBegin) < stmCount))
    {
        __nop();
...
{
    {long long tmp; __asm__("imask %A0,%1,%2,%3" :"=d"((long long)tmp) :"d"((0x1)),"d"((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE1C" : "=d" (__res) :: "memory"); __res; }))),"i"(1): "memory"); __asm__("ldmst [%0]0,%A1"::"a"(event),"d"(tmp): "memory");};
}
