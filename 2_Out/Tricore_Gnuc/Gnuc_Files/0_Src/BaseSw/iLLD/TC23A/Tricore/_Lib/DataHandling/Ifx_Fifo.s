...
.LVL5:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8765
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 79
.LVL6:
	lea	%a6, [%a6] lo:__func__.8765
...
.LVL11:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8755
	nez.a	%d4, %a2
	mov	%d5, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d6, 59
	lea	%a6, [%a6] lo:__func__.8755
	.loc 1 57 0
	mov.aa	%a15, %a2
.LVL12:
	.loc 1 59 0
...
.LVL55:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8778
	mov	%d4, 2
.LVL56:
	lea	%a4, [%a4] lo:.LC3
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 123
	lea	%a6, [%a6] lo:__func__.8778
	st.w	[%SP] 4, %d6
	st.w	[%SP]0, %d7
	call	Ifx_Assert_doLevel
.LVL57:
...
.LBE543:
	...
	movh.a	%a4, hi:.LC4
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8801
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC4
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 199
	lea	%a6, [%a6] lo:__func__.8801
	st.w	[%SP] 8, %d6
	st.w	[%SP] 4, %d7
	st.a	[%SP] 12, %a2
	call	Ifx_Assert_doLevel
...
.LBB598:
	...
	mov	%d6, 0
#APP
	# 133 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Std/IfxCpu_IntrinsicsGnuc.h" 1
	max %d4, %d6, %d4
	# 0 "" 2
.LVL143:
#NO_APP
...
.LVL165:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8823
	mov	%d4, 2
.LVL166:
	lea	%a4, [%a4] lo:.LC3
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 281
	lea	%a6, [%a6] lo:__func__.8823
	st.w	[%SP] 4, %d6
	st.w	[%SP]0, %d7
	call	Ifx_Assert_doLevel
.LVL167:
...
.LBE787:
	...
	movh.a	%a4, hi:.LC4
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8845
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC4
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 353
	lea	%a6, [%a6] lo:__func__.8845
	st.w	[%SP] 8, %d6
	st.w	[%SP] 4, %d7
	st.a	[%SP] 12, %a2
	call	Ifx_Assert_doLevel
...
.section .rodata.__func__.8845,"a",@progbits
	.type	__func__.8845, @object
	.size	__func__.8845, 15
__func__.8845:
	.string	"Ifx_Fifo_write"
.section .rodata.__func__.8823,"a",@progbits
	.type	__func__.8823, @object
	.size	__func__.8823, 23
__func__.8823:
	.string	"Ifx_Fifo_canWriteCount"
.section .rodata.__func__.8801,"a",@progbits
	.type	__func__.8801, @object
	.size	__func__.8801, 14
__func__.8801:
	.string	"Ifx_Fifo_read"
.section .rodata.__func__.8778,"a",@progbits
	.type	__func__.8778, @object
	.size	__func__.8778, 22
__func__.8778:
	.string	"Ifx_Fifo_canReadCount"
.section .rodata.__func__.8765,"a",@progbits
	.type	__func__.8765, @object
	.size	__func__.8765, 14
__func__.8765:
	.string	"Ifx_Fifo_init"
.section .rodata.__func__.8755,"a",@progbits
	.type	__func__.8755, @object
	.size	__func__.8755, 16
__func__.8755:
...
.section .text,"ax",@progbits
.Letext0:
	.file 6 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-1.1\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h"
	...
	.file 14 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-1.1\\tricore\\include\\stdlib.h"
	.file 15 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
