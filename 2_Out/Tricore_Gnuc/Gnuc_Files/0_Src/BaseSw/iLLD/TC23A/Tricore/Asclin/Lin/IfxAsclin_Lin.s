...
.LBB520:
.LBB521:
	.file 5 "0_Src/BaseSw/iLLD/TC23A/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
	.loc 5 615 0
	ld.a	%a4, [%a12]0
	mov.aa	%a5, %a13
	mov	%d4, 1
...
.LVL145:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9874
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 419
	lea	%a6, [%a6] lo:__func__.9874
...
.LVL162:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9881
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 436
	lea	%a6, [%a6] lo:__func__.9881
	j	Ifx_Assert_doLevel
.LVL163:
.L137:
	ret
...
.LVL181:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9888
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 469
	lea	%a6, [%a6] lo:__func__.9888
	j	Ifx_Assert_doLevel
.LVL182:
.LFE394:
...
.LVL199:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9896
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 489
	lea	%a6, [%a6] lo:__func__.9896
	j	Ifx_Assert_doLevel
.LVL200:
.LFE395:
...
.Letext0:
	...
	.file 10 "0_Src/BaseSw/iLLD/TC23A/Tricore/_PinMap/IfxAsclin_PinMap.h"
