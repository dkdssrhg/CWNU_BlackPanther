...
.LVL14:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.7035
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 176
.LVL15:
	lea	%a6, [%a6] lo:__func__.7035
...
.L22:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.7055
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 215
	lea	%a6, [%a6] lo:__func__.7055
	call	Ifx_Assert_doLevel
.LVL22:
.L25:
...
.Letext0:
	...
	.file 6 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Trig/IfxGtm_Trig.h"
	.file 7 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Assert.h"
