...
.LVL20:
	.loc 1 279 0
	movh	%d2, hi:defaultConfig.10763
	mov.a	%a2, %d2
	mov.aa	%a3, %a4
	lea	%a15, [%a2] lo:defaultConfig.10763
...
.L53:
	...
	mov.a	%a4, %d14
	mov.a	%a5, %d13
	movh.a	%a6, hi:__func__.10780
	mov	%d4, 2
	mov	%d5, 352
	lea	%a6, [%a6] lo:__func__.10780
...
.L83:
	...
	movh.a	%a4, hi:.LC3
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.10800
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC3
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 458
	lea	%a6, [%a6] lo:__func__.10800
	call	Ifx_Assert_doLevel
.LVL95:
	ld.hu	%d2, [%a12] 12
.L63:
...
.section .rodata.__func__.10800,"a",@progbits
	...
	.size	__func__.10800, 39
__func__.10800:
	.string	"IfxEth_initTransmitDescriptorsRingMode"
.section .rodata.__func__.10780,"a",@progbits
	.type	__func__.10780, @object
	.size	__func__.10780, 38
__func__.10780:
	.string	"IfxEth_initReceiveDescriptorsRingMode"
.section .rodata.defaultConfig.10763,"a",@progbits
	.align 2
	.type	defaultConfig.10763, @object
	.size	defaultConfig.10763, 80
defaultConfig.10763:
	.byte	0
	.byte	17
	.byte	34
