...
.LVL20:
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8283
	mov	%d4, 2
.LVL21:
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 313
	lea	%a6, [%a6] lo:__func__.8283
...
.LVL172:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.8254
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 183
	lea	%a6, [%a6] lo:__func__.8254
	call	Ifx_Assert_doLevel
.LVL173:
.L152:
