...
.LVL21:
	...
	movh.a	%a4, hi:.LC2
	movh.a	%a5, hi:.LC3
	movh.a	%a6, hi:__func__.8432
	mov	%d4, 2
.LVL22:
	lea	%a4, [%a4] lo:.LC2
	lea	%a5, [%a5] lo:.LC3
	mov	%d5, 129
	lea	%a6, [%a6] lo:__func__.8432
...
.LVL87:
	...
	movh.a	%a4, hi:.LC5
	movh.a	%a5, hi:.LC3
	movh.a	%a6, hi:__func__.8415
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC5
	lea	%a5, [%a5] lo:.LC3
	mov	%d5, 83
	lea	%a6, [%a6] lo:__func__.8415
	call	Ifx_Assert_doLevel
.LVL88:
.LBB101:
.LBB102:
	.loc 3 581 0 is_stmt 1 discriminator 2
	ld.hu	%d15, [%a15] 6
.LVL89:
.LBE102:
.LBE101:
...
.LVL110:
	...
	movh.a	%a4, hi:.LC6
	mov.a	%a5, %d14
	movh.a	%a6, hi:__func__.8506
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC6
	mov	%d5, 327
	lea	%a6, [%a6] lo:__func__.8506
	call	Ifx_Assert_doLevel
.LVL111:
	j	.L125
.LVL112:
...
.LVL141:
	...
	movh.a	%a4, hi:.LC6
	mov.a	%a5, %d13
	movh.a	%a6, hi:__func__.8532
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC6
	mov	%d5, 419
	lea	%a6, [%a6] lo:__func__.8532
	call	Ifx_Assert_doLevel
.LVL142:
	j	.L156
.LVL143:
...
.section .rodata.__func__.8601,"a",@progbits
	...
	.size	__func__.8601, 24
__func__.8601:
	.string	"IfxMtu_writeSramAddress"
.section .rodata.__func__.8556,"a",@progbits
	.type	__func__.8556, @object
	.size	__func__.8556, 38
__func__.8556:
	.string	"IfxMtu_runNonDestructiveInversionTest"
.section .rodata.__func__.8532,"a",@progbits
	.type	__func__.8532, @object
	.size	__func__.8532, 21
__func__.8532:
	.string	"IfxMtu_runMarchUTest"
.section .rodata.__func__.8506,"a",@progbits
	.type	__func__.8506, @object
	.size	__func__.8506, 27
__func__.8506:
	.string	"IfxMtu_runCheckerBoardTest"
.section .rodata.__func__.8432,"a",@progbits
	.type	__func__.8432, @object
	.size	__func__.8432, 22
__func__.8432:
	.string	"IfxMtu_clearSramStart"
.section .rodata.__func__.8415,"a",@progbits
	.type	__func__.8415, @object
	.size	__func__.8415, 17
__func__.8415:
...
.Letext0:
	...
	.file 13 "0_Src/BaseSw/iLLD/TC23A/Tricore/Scu/Std/IfxScuCcu.h"
