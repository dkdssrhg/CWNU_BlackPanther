...
.LVL38:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9307
	mov	%d4, 3
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 91
	lea	%a6, [%a6] lo:__func__.9307
...
.L51:
	...
	movh.a	%a4, hi:.LC0
	movh.a	%a5, hi:.LC1
	movh.a	%a6, hi:__func__.9338
	mov	%d4, 2
	lea	%a4, [%a4] lo:.LC0
	lea	%a5, [%a5] lo:.LC1
	mov	%d5, 187
	lea	%a6, [%a6] lo:__func__.9338
	call	Ifx_Assert_doLevel
.LVL84:
	j	.L33
.LFE304:
