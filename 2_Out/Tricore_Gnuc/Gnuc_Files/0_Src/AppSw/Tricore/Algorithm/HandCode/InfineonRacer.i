# 1 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c"
# 1 "C:\\Tools\\Workspaces\\CWNU_BlackPanther//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c"
...
# 9 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h"
...
# 10 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h" 2
...
# 11 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h" 2
...
extern void Find_Cross(void);
extern void Control_Velocity (void);
# 5 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c" 2
...
# 6 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c" 2
# 15 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c"
typedef enum now_status{
 normal = 0,
 v_limit
}status_t;
# 27 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c"
...
# 49 "0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.c"
...
void InfineonRacer_detectLane(void){
 ...
 error_left = 63.5 - index_left;
 error_right = index_right - 63.5;

 if( error_left - error_right > 5 )
 {
  IR_Srv.Angle = -0.1;
 }
 ...
 if ( (error_left - error_right > -5) && (error_left - error_right < 5) )
 {
  IR_Srv.Angle = 0.0;
 }
}
...
void FindIndex( void )
{
 float pixel_left_sum = 0.0;
 float pixel_right_sum = 0.0;

 int pixel_left;
 int pixel_right;

 float pixel_LeftCount = 0.0;
 ...
 for(pixel_left = 0; pixel_left <= 63; pixel_left++)
 {
  if(IR_LineScan.adcResult[1][pixel_left] < 2000)
  {
   pixel_left_sum = pixel_left + pixel_left_sum;
   pixel_LeftCount++;
   pixel_count_cross++;
  }
 }
 index_left = pixel_left_sum / pixel_LeftCount;



 for(pixel_right = 64; pixel_right < 128; pixel_right++)
 {
